...
const CTA = () => {
  ...
  return (
    <section
      id="contact"
      className="relative w-full flex justify-center items-center bg-slate-50 dark:bg-slate-950 transition-colors duration-300 overflow-hidden"
    >
      {/* Soft background glow */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-[500px] h-[300px] bg-blue-100 dark:bg-blue-900/20 rounded-full blur-3xl opacity-50" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-md:gap-4 max-w-2xl mx-auto">
        ...
        <p className="md:mt-5 text-slate-500 dark:text-slate-400 !text-base">
